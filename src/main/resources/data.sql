INSERT INTO place (place_id, name, category, detail_address, distance, description, address, rode_name_address,
                   local_address, stars, visitor_review,
                   blog_review, direction, close_time, number, characters, sns, detail)
VALUES (1, '알고', '스파게티, 파스타전문', '서울 광진구 광나루로 17길 10', '935m', '수제맥주와 소세지가 맛있는 곳', '서울 광진구', '광나루로17길 10 2층',
        '군자동 378-8 2층', '4.82', 295,
...
INSERT INTO place (place_id, name, category, detail_address, distance, description, address, rode_name_address, ㅌㄴ
    local_address, stars, visitor_review,
                   blog_review, direction, close_time, number, characters, sns, detail)
